...
Mood automatically influences genre filtering.
...
This makes recommendations feel intentional and personalized.
...
The API key is used client-side for demo purposes.

For production-level security, a backend proxy would be recommended.
...
CineMuse focuses on **emotion**.

It aims to make movie discovery:
- Intentional  
- Curated  
- Personal  
- Cinematic  
